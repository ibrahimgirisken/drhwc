                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <form method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-body">
                                        <center><img id="coverImageShow" src="{{ asset('img/sliders')}}{{'/'.$slider->desktop}}" width="70%" height="350px"></center>
                                        <br>
                                    ...
                                    <div class="tab-content" id="custom-content-below-tabContent">
                                        <div class="tab-pane fade active show" id="custom-content-below-home" role="tabpanel" aria-labelledby="custom-content-below-home-tab">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="trTitle" class="form-control" id="exampleInputPassword1" value="{{$sliderTr->title}}" placeholder="Başlık">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Açıklama</label>
                                                    <input type="text" name="trContent" class="form-control" id="exampleInputPassword1" value="{{$sliderTr->content}}" placeholder="Açıklama">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Url Adresi</label>
                                                    <input type="text" name="trUrl" class="form-control" id="exampleInputPassword1" value="{{$sliderTr->url}}" placeholder="Url Adresi">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="custom-content-below-profile" role="tabpanel" aria-labelledby="custom-content-below-profile-tab">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Başlık</label>
                                                    <input type="text" name="enTitle" class="form-control" id="exampleInputPassword1" value="{{$sliderEn->title}}" placeholder="Başlık">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Açıklama</label>
                                                    <input type="text" name="enContent" class="form-control" id="exampleInputPassword1" value="{{$sliderEn->content}}" placeholder="Açıklama">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Url Adresi</label>
                                                    <input type="text" name="enUrl" class="form-control" id="exampleInputPassword1" value="{{$sliderEn->url}}" placeholder="Url Adresi">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="custom-content-below-messages" role="tabpanel" aria-labelledby="custom-content-below-messages-tab">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Başlık</label>
                                                    <input type="text" name="deTitle" class="form-control" id="exampleInputPassword1" value="{{$sliderDe->title}}" placeholder="Başlık">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Açıklama</label>
                                                    <input type="text" name="deContent" class="form-control" id="exampleInputPassword1" value="{{$sliderDe->content}}" placeholder="Açıklama">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Url Adresi</label>
                                                    <input type="text" name="deUrl" class="form-control" id="exampleInputPassword1" value="{{$sliderDe->url}}" placeholder="Url Adresi">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="order" class="form-control" id="exampleInputPassword1" value="{{$slider->order}}" placeholder="Sıra No">
                                        </div>
                                        <div class="form-group">
                                            <label>Durum</label><br>
                                            <input type="checkbox" name="status" name="menu_status" data-bootstrap-switch {{$slider->status=='on' ? 'checked':""}} >
                                        </div>
                                        <div class="form-group">
