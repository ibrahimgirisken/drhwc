            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('page-add') }}"
                                        class="btn btn-primary nav-link {{ request()->is('admin/page-add') ? 'active' : '' }}"><i class="fas fa-plus"></i> Ekle</a>
                    </div>
                </div>
                </div>
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tr>
                            <td>{{$page->title}}</td>
                            <td><input type="checkbox" name="status" name="menu_status" data-bootstrap-switch {{$page->status=='on' ? 'checked':""}} ></td>
                            <td>
