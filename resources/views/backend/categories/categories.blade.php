            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('category-add') }}"
                                        class="btn btn-primary nav-link {{ request()->is('admin/category-add') ? 'active' : '' }}"><i class="fas fa-plus"></i> Ekle</a>
                    </div>
                </div>
                </div>
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody id="sortable">
                            ...
                            <tr id="item-{{$category->id}}">
                                ...
                                <td><input type="checkbox" name="status" name="category_status" data-bootstrap-switch {{$category->status=='on' ? 'checked':""}} ></td>
                               <td>{{$category->created_at}}</td>
                                <td>
                                    <a href="{{route('category-edit',$category->id)}}" class="btn btn-primary"><i class="fas fa-edit"></i>&nbsp;Düzenle</a>
